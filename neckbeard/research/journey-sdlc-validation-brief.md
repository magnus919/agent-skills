...
1. **F1 — Record rollback/follow-up triggers at phase 9 closeout** so the terminal packet states what would cause re-entry (aligns journey with core-loop step 5; 15288 Operation/Maintenance, ITIL Deliver & Support).
