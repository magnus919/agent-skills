...
| `scripts/` | Offline/live probe, read-only routing demo, Jev QA pilot, advisory eval audit and private calibration/reviewer comparison, binary evaluator, and private Laya HTTP adapter |
