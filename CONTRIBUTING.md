...
Mark model-produced label files with `reviewer_kind: model_teacher`; the calibration helper treats missing provenance as `unknown`, not human. Preserve that field when comparing or reporting review results.
