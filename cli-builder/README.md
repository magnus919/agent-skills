...
- **Design `--json` as a documented contract** for machine-readable output agents can consume
- **Establish or review idempotency** so safe reruns are explicit rather than assumed
